...
import com.azaat.grpcchatclient.MessengerProto;
import com.azaat.grpcchatclient.MessengerGrpc;
...
//      int port = TextUtils.isEmpty(portStr) ? 0 : Integer.valueOf(portStr);
      ...
      try {
        ...
        MessengerProto.MessengerMessage request = MessengerProto.MessengerMessage
                ...
                .setWhoami("Azat").build();
        MessengerProto.MessengerReply reply = stub.sayMessage(request);
